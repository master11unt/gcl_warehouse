...
class OptionsSectionWidget extends StatelessWidget {
  ...
  final Widget Function(IconData, String, {bool isDisabled}) buildOptionButton;
      ...
      child: Column(
        ...
        children: [
          ...
          SingleChildScrollView(
            ...
            child: Row(
              children: [
                buildOptionButton(Icons.ads_click, 'Action'),
                const SizedBox(width: 21),
                buildOptionButton(Icons.edit_square, 'Edit'),
                const SizedBox(width: 21),
