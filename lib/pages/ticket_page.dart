...
class _TicketPageState extends State<TicketPage> with TickerProviderStateMixin {
  ...
  Widget _buildTicketCargoInTab() {
    final totalItems = _cargoInAllRows.length;
    ...
    final visibleRows = TicketData.paginateRows(_cargoInAllRows, page, TicketData.cargoInPageSize);
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Expanded(
                    child: _buildSummaryItem("1904", "Scheduled\nTicket"),
                  ),
                  Container(
                    width: 1,
                    height: 72,
                  ...
                  Expanded(
                    child: _buildSummaryItem("5938", "Checked-In\nTicket"),
                  ),
                ],
              ),
            ],
          ...
          child: Column(
            ...
            children: [
              ...
              TicketTable(
                ...
                onPageChange:
                    (p) =>
                        setState(() => _cargoInPage = p.clamp(1, totalPages)),
                onRowTap: (row) {
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Expanded(
                    child: _buildSummaryItem("342", "Scheduled\nTicket"),
                  ),
                  Container(
                    width: 1,
                    height: 72,
                  ...
                  Expanded(
                    child: _buildSummaryItem("1204", "Checked-In\nTicket"),
                  ),
                ],
              ),
            ],
          ...
          child: Column(
            ...
            children: [
              ...
              TicketTable(
                ...
                onPageChange:
                    (p) =>
                        setState(() => _stuffingPage = p.clamp(1, totalPages)),
                onRowTap: (rowData) {
