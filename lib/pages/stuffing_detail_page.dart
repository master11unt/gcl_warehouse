...
class StuffingDetailPage extends StatefulWidget {
  final Map<String, dynamic> stuffingData;

  const StuffingDetailPage({
    super.key,
    required this.stuffingData,
  });

  @override
  State<StuffingDetailPage> createState() => _StuffingDetailPageState();
}

class _StuffingDetailPageState extends State<StuffingDetailPage> {
  @override
          ...
          Expanded(
            child: Row(
              children: [
                ...
                Flexible(
                  child: Text(
                    widget.stuffingData['jobNumber'] ?? 'GCL-1002507096',
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(
                child: _buildDetailItem('Job Number', widget.stuffingData['jobNumber'] ?? 'GCL-1002507096'),
              ),
              const SizedBox(width: 16),
              // Action buttons
              Row(
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    _buildDetailItem('Destination', widget.stuffingData['destination'] ?? 'SHANGHAI'),
                    _buildDetailItem('Container Number', widget.stuffingData['containerNumber'] ?? 'KOCU5009373 / 24H0102212'),
                    _buildDetailItem('Estimated Time Departure', widget.stuffingData['etd'] ?? '2025-08-02'),
                    _buildDetailItem('Vessel', widget.stuffingData['vessel'] ?? 'HMM MIRACLE V 009N'),
                    _buildDetailItem('Agent', widget.stuffingData['agent'] ?? 'PORTSHA'),
                  ],
                ),
              ),
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    _buildDetailItem('Stuffing Date', widget.stuffingData['stuffingDate'] ?? '2025-07-31'),
                    _buildDetailItem('Container Size', widget.stuffingData['containerSize'] ?? '40HC'),
                    _buildDetailItem('Closing Date', widget.stuffingData['closingDate'] ?? '2025-08-31\n00:00:00'),
                    _buildDetailItem('Stuffing Owner', widget.stuffingData['stuffingOwner'] ?? 'GCL-JAKARTA'),
                  ],
                ),
              ),
            ],
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Based On : ${widget.stuffingData['rulesReference'] ?? 'GTW/SOP/JKT/122331'}',
            style: const TextStyle(
              fontSize: 14,
              fontWeight: FontWeight.w400,
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            // ),
            child: QrImageView(
              data: widget.stuffingData['jobNumber'] ?? 'GCL-1002507096',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            widget.stuffingData['requestedBy'] ?? 'SITI AISYAH',
            style: const TextStyle(
              fontSize: 14,
              fontWeight: FontWeight.w600,
              color: Color(0xFF111827),
          ...
          Row(
            ...
            children: [
              Text(
                widget.stuffingData['requestDate'] ?? '2025-07-24',
                style: const TextStyle(
                  fontSize: 12,
                  fontWeight: FontWeight.w400,
                  color: Color(0xFF6B7280),
